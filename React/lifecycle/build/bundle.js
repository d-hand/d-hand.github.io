...
var CountryList = function (_React$Component) {
    ...
    function CountryList(props) {
        ...
        _this.fetchCountryList = function () {
            _this.setState({ loading: true });
            setTimeout(function () {
                (0, _isomorphicFetch2.default)('https://restcountries.eu/rest/v1/all').then(function (response) {
                    return response.json();
                }).then(function (json) {
                    return json.slice(1, _this.props.count || json.length).map(function (country) {
                        return country.name;
                    });
                }).then(function (countryNames) {
                    return _this.setState({ countryNames: countryNames, loading: false });
                });
            }, _this.props.delay);
        };
    ...
    _createClass(CountryList, [{
        ...
        value: function render() {
            ...
            var _state = this.state,
                countryNames = _state.countryNames,
            ...
            return loading ? _react2.default.createElement(
            ...
            ) : !countryNames.length ? _react2.default.createElement(
                'div',
                null,
                'No country Names'
            ) : _react2.default.createElement(
                'ul',
                { onClick: this.fetchCountryList },
                countryNames.map(function (x, i) {
                ...
                _react2.default.createElement(
                    'li',
                    { className: 'country-list-comment' },
                    count > 0 ? '(\u043F\u0435\u0440\u0432\u044B\u0435 ' + count + ' \u0441\u0442\u0440\u0430\u043D)' : ""
                )
            );
        }
    }]);
...
var RotationMessages = function (_React$Component) {
    _inherits(RotationMessages, _React$Component);

    function RotationMessages(props) {
        _classCallCheck(this, RotationMessages);

        var _this = _possibleConstructorReturn(this, (RotationMessages.__proto__ || Object.getPrototypeOf(RotationMessages)).call(this, props));

        _this.state = {
            messages: ["The crow crows after midnight", "Bring a watch and dark clothes to the spot", "Jericho Jericho Go"],
            showing: -1
        };
        return _this;
    }
    ...
    _createClass(RotationMessages, [{
        ...
        value: function componentWillMount() {
            ...
            this.interval = setInterval(function () {
                ...
                _this2.setState({ showing: showing });
            }, 1000);
        }
    }, {
    ...
    return RotationMessages;
}(_react2.default.Component);

exports.default = RotationMessages;
...
var WorkerList = function (_React$Component) {
    ...
    function WorkerList() {
        ...
        var _this = _possibleConstructorReturn(this, (WorkerList.__proto__ || Object.getPrototypeOf(WorkerList)).call(this));

        _this.willGetFakeWorkers = function () {
            _this.setState({ loading: true });
            _this.getFakeWorkers(_this.props.count).then(function (workers) {
                return _this.setState({ workers: workers, loading: false });
            }, function (error) {
                return _this.setState({ error: error, loading: false });
            });
        };

        _this.getFakeWorkers = function (count) {
    ...
    _createClass(WorkerList, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'worker-list', onClick: this.willGetFakeWorkers },
                loading ? _react2.default.createElement(
                    'span',
                    null,
                    'Loading Workers'
                ) : workers.length ? workers.map(function (worker, i) {
                    return _react2.default.createElement(Worker, _extends({ key: i }, worker));
                }) : _react2.default.createElement(
                    'span',
                    null,
                    '0 workers loaded...'
...
var Worker = function Worker(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'worker' },
        _react2.default.createElement('img', { src: picture.thumbnail, alt: '' }),
        _react2.default.createElement(
            'h1',
            null,
            name.first,
...
var _WorkerList = __webpack_require__(/*! WorkerList */ "./src/WorkerList.js");

var _WorkerList2 = _interopRequireDefault(_WorkerList);

var _RotationMessages = __webpack_require__(/*! RotationMessages */ "./src/RotationMessages.js");

var _RotationMessages2 = _interopRequireDefault(_RotationMessages);

var _CountryList = __webpack_require__(/*! CountryList */ "./src/CountryList.js");
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    _react2.default.createElement(_WorkerList2.default, { count: 2 }),
    _react2.default.createElement(_CountryList2.default, { delay: 3000, count: 10 }),
    _react2.default.createElement(_RotationMessages2.default, null)
