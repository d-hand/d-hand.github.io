...
var FetchComponent = function FetchComponent(ComposedComponent, url) {
    return function (_React$Component) {
        _inherits(FetchComponent, _React$Component);

        function FetchComponent(props) {
            _classCallCheck(this, FetchComponent);

            var _this = _possibleConstructorReturn(this, (FetchComponent.__proto__ || Object.getPrototypeOf(FetchComponent)).call(this, props));
...
var FlexItems = _styledComponents2.default.div(_templateObject);

var FlexItem = _styledComponents2.default.section(_templateObject2);
